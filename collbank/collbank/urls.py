...
urlpatterns = [
    ...
    url(r'^output/(?P<pk>\d+)$', CollectionDetailView.as_view(),  {'type': 'output'}, name='output'),
    url(r'^handle/(?P<pk>\d+)$', CollectionDetailView.as_view(),  {'type': 'handle'}, name='handle'),
    url(r'^registry/(?P<slug>[-\w]+)$', CollectionDetailView.as_view(),  {'type': 'registry'}, name='registry'),
