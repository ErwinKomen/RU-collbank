# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-10-03 09:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('2', 'academic'), ('4', 'other'), ('1', 'public'), ('3', 'restricted')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-5439_98bb103d-476a-7f62-54b4-bf9de24d2229'>Access: type of license</a>", max_length=5, verbose_name='Access availability')),
            ],
        ),
        migrations.CreateModel(
            name='AccessContact',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('33', 'AIF'), ('34', 'BAS'), ('35', 'MT'), ('36', 'TRS'), ('1', 'application/json'), ('2', 'application/pdf'), ('37', 'other'), ('3', 'text/html'), ('4', 'text/plain'), ('5', 'text/plain-bas'), ('6', 'text/praat-textgrid'), ('21', 'text/x-cgn-bpt+xml'), ('22', 'text/x-cgn-lxk+xml'), ('23', 'text/x-cgn-pri+xml'), ('24', 'text/x-cgn-prx+xml'), ('25', 'text/x-cgn-skp+xml'), ('26', 'text/x-cgn-tag+xml'), ('27', 'text/x-cgn-tig+xml'), ('8', 'text/x-chat'), ('9', 'text/x-cut'), ('10', 'text/x-eaf+xml'), ('11', 'text/x-esf'), ('38', 'text/x-folia+xml'), ('29', 'text/x-jasmin-awd+text'), ('31', 'text/x-jasmin-hmi+text'), ('28', 'text/x-jasmin-ort+text'), ('30', 'text/x-jasmin-pos+text'), ('39', 'text/x-laf+xml'), ('12', 'text/x-lexus-config+xml'), ('13', 'text/x-lexus-resource+xml'), ('14', 'text/x-lmf+xml'), ('32', 'text/x-mmax+xml'), ('15', 'text/x-shoebox-language'), ('18', 'text/x-shoebox-lexicon'), ('16', 'text/x-shoebox-text'), ('17', 'text/x-shoebox-type'), ('20', 'text/x-toolbox-lexicon'), ('19', 'text/x-toolbox-text'), ('7', 'text/xml')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2562_872eb94a-47fb-b551-2f64-13ded063259e'>Format of this annotation layer</a>", max_length=5, verbose_name='Annotation format')),
            ],
        ),
        migrations.CreateModel(
            name='Audience',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('speechCoding', models.CharField(blank=True, default='unknown', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-5514_145df064-6ac4-f0d3-7de8-1002dfb9b45e'>Speech coding</a>", max_length=25, verbose_name='Speech coding')),
                ('samplingFrequency', models.CharField(blank=True, default='unknown', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2577_73344cc2-f341-8842-bcf7-48e5267a3aca'>Sampling frequency</a>", max_length=25, verbose_name='Sampling frequency')),
                ('compression', models.CharField(blank=True, default='unknown', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2685_65492121-3759-0fc2-694b-83eccbb9d26c'>Compression</a>", max_length=25, verbose_name='Compression')),
                ('bitResolution', models.CharField(blank=True, default='unknown', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2684_ac8bdf07-61be-d478-53f7-8949139e11fc'>Bit resolution</a>", max_length=25, verbose_name='Bit resolution')),
            ],
        ),
        migrations.CreateModel(
            name='Channel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('format', models.CharField(choices=[('1', 'manual'), ('5', 'none'), ('4', 'other'), ('2', 'readme file'), ('3', 'website')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-5434_9c284553-b24c-d3ea-f3e8-5bebf0ee5f44'>Documentation: type</a>", max_length=5, verbose_name='Kind of documentation')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('20', 'academic-nonfiction'), ('2', 'conversation'), ('22', 'fiction'), ('4', 'interviews'), ('19', 'lectures'), ('7', 'newspaper-article'), ('21', 'non-academic-non-fiction'), ('17', 'other'), ('24', 'personal-notes'), ('11', 'prompted speech'), ('12', 'radio/TV-broadcast'), ('25', 'social-media-texts'), ('15', 'speeches'), ('23', 'stimuli'), ('26', 'test-scores'), ('18', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2470_d191f2b2-6339-f031-b534-70d526b28357'>Genre of the collection as a whole</a>", max_length=5, verbose_name='Collection genre')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('3', 'audio/x-aiff'), ('4', 'audio/x-mp2'), ('5', 'audio/x-mp3'), ('6', 'audio/x-mpeg4'), ('7', 'audio/x-wav'), ('11', 'image/gif'), ('8', 'image/jpeg'), ('9', 'image/png'), ('10', 'image/tiff'), ('20', 'other'), ('22', 'text/csv'), ('14', 'text/folia'), ('12', 'text/html'), ('23', 'text/laf'), ('1', 'text/pdf'), ('13', 'text/tei'), ('2', 'text/xml'), ('21', 'unknown'), ('18', 'video/quicktime'), ('15', 'video/x-mpeg1'), ('16', 'video/x-mpeg2'), ('17', 'video/x-mpeg4'), ('19', 'video/x-msvideo')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2571_2be2e583-e5af-34c2-3673-93359ec1f7df'>Format of this resource medium</a>", max_length=5, verbose_name='Format of a medium')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('1', 'home/office'), ('6', 'other'), ('3', 'public-place'), ('2', 'studio'), ('7', 'unknown'), ('5', 'vehicle')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2696_d3b0e503-d971-8849-5c6f-128cf2f56fb4'>Recording environment</a>", max_length=5, verbose_name='Environment for the recording')),
            ],
        ),
        migrations.CreateModel(
            name='Relation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='-', help_text="See: <a href='http://purl.org/dc/terms/relation'>Relation</a>", max_length=80, verbose_name='Relation with something else')),
            ],
        ),
        migrations.CreateModel(
            name='Resource',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numberOfSpeakers', models.CharField(blank=True, default='unknown', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2692_35679421-596d-40dd-8482-44741eea4f15'>Number of speakers involved</a>", max_length=20, verbose_name='Number of speakers')),
                ('additional', models.IntegerField(blank=True, default=0, help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2692_35679421-596d-40dd-8482-44741eea4f15'>Number of speakers involved</a>", verbose_name='Number of speakers')),
                ...
                ('audioFormat', models.ManyToManyField(blank=True, to='collection.AudioFormat')),
        ...
        migrations.AddField(
            model_name='collection',
            name='provenance',
            field=models.ManyToManyField(blank=True, to='collection.Provenance'),
        ),
        migrations.AddField(
            model_name='collection',
            name='relation',
        ...
        migrations.AddField(
            ...
            name='formatAnn',
            field=models.ManyToManyField(to='collection.AnnotationFormat'),
        ),
        migrations.AddField(
            model_name='access',
            name='availability',
