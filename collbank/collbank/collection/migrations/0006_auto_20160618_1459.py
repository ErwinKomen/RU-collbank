# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-18 12:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('collection', '0005_auto_20160618_1443'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('2', 'dialogue'), ('1', 'monologue'), ('3', 'multilogue'), ('4', 'not-a-natural-format'), ('5', 'other'), ('6', 'unknown')], default='0', help_text='Sorry, no help available for speechcorpus.conversationaltype', max_length=5, verbose_name='Type of conversation')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='speechcorpus',
            name='channel',
            field=models.ManyToManyField(blank=True, to='collection.Channel'),
        ),
        migrations.RemoveField(
            model_name='speechcorpus',
            name='conversationalType',
        ...
        migrations.AddField(
            model_name='speechcorpus',
            name='recordingEnvironment',
            field=models.ManyToManyField(blank=True, to='collection.RecordingEnvironment'),
        ),
        ...
        migrations.AddField(
            model_name='speechcorpus',
            name='conversationalType',
            field=models.ManyToManyField(blank=True, to='collection.ConversationalType'),
        ),
    ]
