# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-06-27 14:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('collection', '0009_auto_20160627_0942'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ISBN', models.TextField(verbose_name='ISBN of collection')),
                ('ISLRN', models.TextField(verbose_name='ISLRN of collection')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('format', models.CharField(default='0', help_text='Sorry, no help available for access.medium.format', max_length=5, verbose_name='Resource medium')),
            ],
        ),
        migrations.CreateModel(
            name='AccessWebsite',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('2', 'CDROM'), ('3', 'DVD'), ('1', 'application/pdf'), ('2', 'application/smil+xml'), ('3', 'audio/x-aiff'), ('4', 'audio/x-mp2'), ('5', 'audio/x-mp3'), ('6', 'audio/x-mpeg4'), ('7', 'audio/x-wav'), ('4', 'blueray'), ('5', 'hard disk'), ('11', 'image/gif'), ('8', 'image/jpeg'), ('9', 'image/png'), ('10', 'image/tiff'), ('1', 'internet'), ('7', 'other'), ('20', 'other'), ('6', 'paper copy'), ('14', 'text/folia'), ('12', 'text/html'), ('13', 'text/tei'), ('21', 'unknown'), ('8', 'video'), ('18', 'video/quicktime'), ('15', 'video/x-mpeg1'), ('16', 'video/x-mpeg2'), ('17', 'video/x-mpeg4'), ('19', 'video/x-msvideo')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2571_2be2e583-e5af-34c2-3673-93359ec1f7df'>Format of this resource medium</a>", max_length=5, verbose_name='Format of a medium')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sizeUnit', models.CharField(default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2583_5f5cb491-1037-8d46-d685-ccebfc0233f7'>Units used for the amount</a>", max_length=5, verbose_name='Units')),
            ],
        ),
        migrations.CreateModel(
            name='Validation',
        ...
        migrations.AddField(
            model_name='resource',
            name='media',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='collection.Media'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='domain',
            name='name',
            field=models.CharField(default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2467_f4e7331f-b930-fc42-eeea-05e383cfaa78'>Domain</a>", max_length=5, verbose_name='Domain'),
        ),
        migrations.AlterField(
            model_name='genre',
            name='name',
        ...
        migrations.RemoveField(
            model_name='writtencorpus',
            name='characterEncoding',
        ),
        migrations.AddField(
            model_name='writtencorpus',
            name='characterEncoding',
            field=models.ManyToManyField(blank=True, to='collection.CharacterEncoding'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='access',
            name='nonCommercialUsageOnly',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='collection.NonCommercialUsageOnly'),
        ),
        migrations.AddField(
            model_name='access',
            name='website',
        ...
        migrations.AddField(
            model_name='collection',
            name='access',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='collection.Access'),
        ),
        migrations.AddField(
            model_name='collection',
            name='documentation',
        ...
        migrations.AddField(
            model_name='speechcorpus',
            name='audience',
            field=models.ManyToManyField(blank=True, to='collection.Audience'),
        ),
        migrations.AddField(
            model_name='speechcorpus',
            name='interactivity',
            field=models.ManyToManyField(blank=True, to='collection.Interactivity'),
        ),
        migrations.AddField(
            model_name='speechcorpus',
            name='involvement',
            field=models.ManyToManyField(blank=True, to='collection.Involvement'),
        ),
        migrations.AddField(
            model_name='speechcorpus',
            name='planningType',
            field=models.ManyToManyField(blank=True, to='collection.PlanningType'),
        ),
        migrations.AddField(
            model_name='speechcorpus',
            name='recordingConditions',
            field=models.ManyToManyField(blank=True, to='collection.RecordingCondition'),
        ),
        migrations.AddField(
            model_name='speechcorpus',
            name='socialContext',
            field=models.ManyToManyField(blank=True, to='collection.SocialContext'),
        ),
        migrations.AddField(
            model_name='media',
            name='format',
