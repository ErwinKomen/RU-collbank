# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-06 08:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('collection', '0015_auto_20160705_0804'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(choices=[('2', 'academic'), ('4', 'other'), ('1', 'public'), ('3', 'restricted')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-5439_98bb103d-476a-7f62-54b4-bf9de24d2229'>Access: type of license</a>", max_length=5, verbose_name='Domain'),
        ),
        migrations.AlterField(
            model_name='accesscontact',
            name='address',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2505_b61e249b-ac68-b40a-0f21-03a4a26e16b4'>Address</a>", verbose_name='Access: address of contact'),
        ),
        migrations.AlterField(
            model_name='accesscontact',
            name='email',
            field=models.EmailField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2521_7b01b455-0de8-d753-ad4e-dee49953ae98'>Email</a>", max_length=254, verbose_name='Access: email of contact'),
        ),
        migrations.AlterField(
            model_name='accesscontact',
            name='person',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2978_0e9e4864-44c4-de22-66b1-9b38bca10836'>Person</a>", verbose_name='Access: person to contact'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.URLField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2546_180dca37-c1d8-dffe-5d46-8f16de143320'>Web reference</a>", verbose_name='Website to access the collection'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='annotation',
            name='mode',
            field=models.CharField(choices=[('1', 'automatic'), ('4', 'interactive'), ('2', 'manual'), ('3', 'mixed'), ('5', 'other'), ('6', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2506_48f68696-57f3-74da-38e8-aa0f8e6ecc2f'>Annotation mode</a>", max_length=5, verbose_name='Annotation mode'),
        ),
        migrations.AlterField(
            model_name='annotation',
            name='type',
        ...
        migrations.AlterField(
            model_name='audience',
            name='name',
            field=models.CharField(choices=[('4', 'large'), ('3', 'medium'), ('1', 'no'), ('5', 'other'), ('2', 'small'), ('6', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-6266_8a69d58b-e6a0-cf4e-934d-cbb1ac4417ac'>Audience type</a>", max_length=5, verbose_name='Audience'),
        ),
        migrations.AlterField(
            model_name='channel',
            name='name',
            field=models.CharField(choices=[('3', 'broadcasting'), ('2', 'experimental-setting'), ('1', 'face-to-face'), ('6', 'human-machine-dialogue'), ('7', 'other'), ('4', 'telephone'), ('8', 'unknown'), ('5', 'wizard-of-ozz')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2464_be58b081-dad1-85f8-d20d-0445078f4ac0'>Channel</a>", max_length=5, verbose_name='Channel for the speech corpus'),
        ),
        migrations.AlterField(
            model_name='characterencoding',
            name='name',
            field=models.CharField(choices=[('2', 'ANSII'), ('1', 'ASCII'), ('3', 'ISO-8859'), ('4', 'UTF7'), ('5', 'UTF8'), ('6', 'other'), ('7', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2564_880b1108-6b03-647f-eed9-cdfbd464c661'>Name of the character encoding</a>", max_length=5, verbose_name='Character encoding'),
        ),
        migrations.AlterField(
            model_name='collection',
            name='clarinCentre',
            field=models.TextField(blank=True, help_text='Clarin centre (Name of the clarin centre)', verbose_name='Clarin centre in charge'),
        ),
        migrations.AlterField(
            model_name='collection',
            name='description',
        ...
        migrations.AlterField(
            model_name='collection',
            name='version',
            field=models.TextField(blank=True, help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2547_7883d382-b3ce-8ab4-7052-0138525a8ba1'>Version information</a>", verbose_name='Version of the collection'),
        ),
        migrations.AlterField(
            model_name='conversationaltype',
            name='name',
            field=models.CharField(choices=[('2', 'dialogue'), ('1', 'monologue'), ('3', 'multilogue'), ('4', 'not-a-natural-format'), ('5', 'other'), ('6', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2469_2160b7a0-80f7-2d68-5f3e-997e052a1602'>Type of conversation (event structure)</a>", max_length=5, verbose_name='Type of conversation'),
        ),
        migrations.AlterField(
            model_name='documentationfile',
            name='name',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-5435_155a7fae-a941-e6a8-4b63-4f6d1bd0c2aa'>Documentation: File</a>", verbose_name='File name for documentation'),
        ),
        migrations.AlterField(
            model_name='documentationtype',
            name='format',
            field=models.CharField(choices=[('1', 'manual'), ('5', 'none'), ('4', 'other'), ('2', 'readme file'), ('3', 'website')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-5434_9c284553-b24c-d3ea-f3e8-5bebf0ee5f44'>Documentation: type</a>", max_length=5, verbose_name='RKind of documentation'),
        ),
        migrations.AlterField(
            model_name='documentationurl',
            name='name',
            field=models.URLField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2546_180dca37-c1d8-dffe-5d46-8f16de143320'>Documentation: URL</a>", verbose_name='URL of documentation'),
        ),
        migrations.AlterField(
            model_name='domaindescription',
            name='name',
            field=models.TextField(default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2467_f4e7331f-b930-fc42-eeea-05e383cfaa78'>Domain</a>", verbose_name='Domain'),
        ),
        migrations.AlterField(
            model_name='genre',
            name='name',
            field=models.CharField(choices=[('1', 'biography'), ('2', 'conversation'), ('3', 'drama'), ('4', 'interviews'), ('5', 'legal-texts'), ('6', 'medical-texts'), ('7', 'newspaper-article'), ('8', 'novel'), ('17', 'other'), ('9', 'personal-notes'), ('10', 'poetry'), ('11', 'prompted speech'), ('12', 'radio/TV-broadcast'), ('13', 'ritual/religious texts'), ('14', 'secondary-document'), ('15', 'speeches'), ('16', 'stimuli'), ('18', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2470_d191f2b2-6339-f031-b534-70d526b28357'>Genre of the collection as a whole</a>", max_length=5, verbose_name='Collection genre'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(choices=[('3', 'codeSwitching'), ('2', 'multilingualSingletext'), ('4', 'other'), ('1', 'parallel'), ('5', 'unknown')], default='0', help_text='Type of multi-linguality (new category)', max_length=5, verbose_name='Type of multi-linguality'),
        ),
        migrations.AlterField(
            model_name='noncommercialusageonly',
            name='name',
            field=models.CharField(choices=[('2', 'no'), ('1', 'yes')], default='0', help_text='Access: non-commercial usage (Boolean)', max_length=5, verbose_name='Non-commercial usage only access'),
        ),
        migrations.AlterField(
            model_name='organization',
            name='name',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2979_8030473e-bbcb-6b87-3fd2-90554429ec50'>Organisation</a>", verbose_name='Name of organization'),
        ),
        migrations.AlterField(
            model_name='owner',
            name='name',
        ...
        migrations.AlterField(
            model_name='person',
            name='name',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2978_0e9e4864-44c4-de22-66b1-9b38bca10836'>Person</a>", verbose_name='Name of person'),
        ),
        migrations.AlterField(
            model_name='pid',
            name='code',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2573_ae7c2548-8a86-ab6e-7099-e28b7697d1a2'>Persistent identifier</a>", verbose_name='Persistent identifier of the collection'),
        ),
        migrations.AlterField(
            model_name='planningtype',
            name='name',
            field=models.CharField(choices=[('4', 'other'), ('3', 'planned'), ('2', 'semi-spontaneous'), ('1', 'spontaneous'), ('5', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2492_304b514c-3633-e348-ddef-f9222c288e10'>Planning type</a>", max_length=5, verbose_name='Type of planning'),
        ),
        migrations.AlterField(
            model_name='project',
            name='title',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2537_fa206273-223a-f4fa-dde3-ba59b965701f'>Title of project</a>", verbose_name='Project title'),
        ),
        migrations.AlterField(
            model_name='projectfunder',
            name='name',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2522_3bdc6af1-bf1b-3f5d-2938-62d99a1980ab'>Funder of project</a>", verbose_name='Funder of project'),
        ),
        migrations.AlterField(
            model_name='projecturl',
            name='name',
            field=models.URLField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2546_180dca37-c1d8-dffe-5d46-8f16de143320'>URL of project</a>", verbose_name='URL of project'),
        ),
        migrations.AlterField(
            model_name='recordingcondition',
            name='name',
            field=models.TextField(help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2566_5a4ee887-bc58-38ee-9b1e-a06f1916d63c'>Condition</a>", verbose_name='Recording condition'),
        ),
        migrations.AlterField(
            model_name='recordingenvironment',
            name='name',
            field=models.CharField(choices=[('1', 'home/office'), ('6', 'other'), ('3', 'public-place'), ('2', 'studio'), ('4', 'telephone'), ('7', 'unknown'), ('5', 'vehicle')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2696_d3b0e503-d971-8849-5c6f-128cf2f56fb4'>Recording environment</a>", max_length=5, verbose_name='Environment for the recording'),
        ),
        migrations.AlterField(
            model_name='relation',
            name='name',
            field=models.CharField(default='0', help_text="See: <a href='http://purl.org/dc/terms/relation'>Relation</a>", max_length=5, verbose_name='Relation with something else'),
        ),
        migrations.AlterField(
            model_name='resource',
            name='type',
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(choices=[('4', 'controlled environment'), ('1', 'family'), ('5', 'other'), ('2', 'private'), ('3', 'public'), ('6', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2493_692957bc-2214-5175-99e5-c727b37ddf0f'>Social context</a>", max_length=5, verbose_name='Social context'),
        ),
        migrations.AlterField(
            model_name='speechcorpus',
            name='durationOfEffectiveSpeech',
            field=models.TextField(blank=True, default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2691_5c1c9d59-cc6d-da0a-cf24-1ee36f0947a7'>Duration of the effective speech</a>", verbose_name='Duration of effective speech'),
        ),
        migrations.AlterField(
            model_name='speechcorpus',
            name='durationOfFullDatabase',
            field=models.TextField(blank=True, default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2690_3d45e6f3-0827-1b1f-b5a5-2ab3b13450fd'>Duration of the full database</a>", verbose_name='Duration of full database'),
        ),
        migrations.AlterField(
            model_name='speechcorpus',
            name='numberOfSpeakers',
            field=models.IntegerField(blank=True, default=0, help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2692_35679421-596d-40dd-8482-44741eea4f15'>Number of speakers involved</a>", verbose_name='Number of speakers'),
        ),
        migrations.AlterField(
            model_name='speechcorpus',
            name='speakerDemographics',
            field=models.TextField(blank=True, default='-', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2960_8a25637f-1367-741e-8708-6f171ced559c'>Demographics of the speaker</a>", verbose_name='Speaker demographics'),
        ),
        migrations.AlterField(
            model_name='title',
            name='name',
        ...
        migrations.AlterField(
            ...
            name='sizeUnit',
            field=models.TextField(default='MB', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2583_5f5cb491-1037-8d46-d685-ccebfc0233f7'>Units used for the amount</a>", verbose_name='Units'),
        ),
        migrations.AlterField(
            model_name='validationmethod',
            name='name',
            field=models.CharField(choices=[('1', 'automatic'), ('2', 'manual'), ('3', 'semi-automatic'), ('4', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2586_75098d25-a517-983f-817c-2b05c5ce361a'>Validation method</a>", max_length=5, verbose_name='Validation method'),
        ),
        migrations.AlterField(
            model_name='validationtype',
            name='name',
            field=models.CharField(choices=[('2', 'content'), ('1', 'formal'), ('3', 'formal/content'), ('4', 'other'), ('5', 'unknown')], default='0', help_text="See: <a href='http://hdl.handle.net/11459/CCR_C-2587_026dcaa6-8ece-3364-8492-6479e70f66de'>Validation type</a>", max_length=5, verbose_name='Validation type'),
        ),
    ]
